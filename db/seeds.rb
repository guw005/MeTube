...
thumbnail1 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/IMG_puppy1.PNG')
video1.thumbnail.attach(io: thumbnail1, filename: 'puppy1.png')
video_file1 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/puppy1.MP4')
...
thumbnail2 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/IMG_puppy2.PNG')
video2.thumbnail.attach(io: thumbnail2, filename: 'puppy2.png')
video_file2 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/puppy2.MP4')
...
thumbnail3 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/IMG_puppy3.PNG')
video3.thumbnail.attach(io: thumbnail3, filename: 'puppy3.png')
video_file3 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/puppy3.MP4')
...
thumbnail4 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/IMG_puppy4.PNG')
video4.thumbnail.attach(io: thumbnail4, filename: 'puppy4.png')
video_file4 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/puppy4.MP4')
video4.video_file.attach(io: video_file4, filename: 'puppy4.mp4')
video4.save

video5 = Video.new(title: "Having fun with my best friend", description: "I'm not a bully", author_id: lucas.id)
thumbnail5 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/IMG_puppy5.PNG')
video5.thumbnail.attach(io: thumbnail5, filename: 'puppy5.png')
video_file5 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/puppy5.MP4')
...
thumbnail6 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video6.png')
video6.thumbnail.attach(io: thumbnail6, filename: 'video6.png')
video_file6 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video6.MP4')
...
thumbnail7 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video7.png')
video7.thumbnail.attach(io: thumbnail7, filename: 'video7.png')
video_file7 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video7.MP4')
...
thumbnail8 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video8.png')
video8.thumbnail.attach(io: thumbnail8, filename: 'video8.png')
video_file8 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video8.MP4')
...
thumbnail9 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video9.png')
video9.thumbnail.attach(io: thumbnail9, filename: 'video9.png')
video_file9 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video9.mp4')
...
thumbnail10 = open('https://active-storage-metube-pro.s3-us-west-1.amazonaws.com/video10.png')
