...
class Api::SessionsController < ApplicationController
    def google_sign_in
      ...
      begin
        payload = validator.check(params[:id_token], JWT.decode(params[:id_token], nil, false)[0]["aud"], "915909549025-o7sjigo0nqih7s4k9ea45kaqs0rhg4j5.apps.googleusercontent.com")
        email = payload['email']
